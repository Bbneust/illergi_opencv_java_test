...
public class CropImageFragment extends Fragment {
    ...
    static {
        if (OpenCVLoader.initDebug()) info("installed");
        else info("uninstalled");
    }
     ...
     * @return A new instance of fragment CropImageFragmentjava.
     */
    // TODO: Rename and change types and number of parameters
    public static CropImageFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.crop_image_fragment, container, false);

        selectButton = rootView.findViewById(R.id.Select);
...
//                startActivity(showResultIntent);
                ...
                args.putString("CropImagePath",croppedImagePath.getAbsolutePath());
                args.putString("SavedImageName",ts+".jpg");
                args.putString("ResultText",Result);

                ShowResultFragment showResultFragment = new ShowResultFragment();
                FragmentManager manager = getFragmentManager();
                showResultFragment.setArguments(args);
    ...
    public static void info(Object msg) {
        Log.e("CropImageFragment", msg.toString());
    }
    ...
    public boolean isNumber(String data){
        try {
            Double.parseDouble(data.replace("%",""));
            return true;
    ...
    public String clean_ingredient(String ingredient){
        String datas[] = ingredient.replace("-","").split("\\s+");
        StringBuilder sb = new StringBuilder();
        String regex = "^[0-9]+$";
        Pattern p = Pattern.compile(regex);
